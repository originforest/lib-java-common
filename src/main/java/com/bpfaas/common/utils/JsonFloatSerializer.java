...
class JsonFloatSerializer extends StdSerializer<Object> {
  /**
   * Singleton instance to use.
   */
  public static final JsonFloatSerializer instance = new JsonFloatSerializer();
   ...
   * @since 2.5
   */
  public JsonFloatSerializer(Class<?> handledType) {
  ...
  /*
   * 01-Mar-2011, tatu: We were serializing as "raw" String; but generally that is
   * not what we want, since lack of type information would imply real String
   * type.
   */
  /**
   * Default implementation will write type prefix, call regular serialization
   * method (since assumption is that value itself does not need JSON Array or
   * Object start/end markers), and then write type suffix. This should work for
